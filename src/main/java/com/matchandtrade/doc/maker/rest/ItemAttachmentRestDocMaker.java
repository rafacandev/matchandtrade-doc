...
public class ItemAttachmentRestDocMaker implements RestDocMaker {
	...
	public String content() {
		...
		AttachmentJson attachment = apiFacade.createFile("front-picture.png");
		...
		Snippet addAttachmentToItem = snippetFactory.makeSnippet(Method.POST, MatchAndTradeRestUtil.filesUrl(membership.getTradeMembershipId(), item.getItemId(), attachment.getAttachmentId()));
		...
		Snippet getAllAttachmentsOfItem = snippetFactory.makeSnippet(MatchAndTradeRestUtil.filesUrl(membership.getTradeMembershipId(), item.getItemId()));
		...
		Snippet deleteAttachmentFromItem = snippetFactory
				.makeSnippet(Method.DELETE, MatchAndTradeRestUtil.filesUrl(membership.getTradeMembershipId(), item.getItemId(), attachment.getAttachmentId()));
